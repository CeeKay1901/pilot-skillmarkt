...
shared/base.css       Design-System + alle geteilten Komponenten (~2.150 Zeilen)
shared/base.js        Engine: Nav, Modal, Rating, Suche, Deep-Links (~2.050 Zeilen)
data/*.js             11 Datendateien, klassische Scripts mit globalen Konstanten
                      (data/seit.js ist ERZEUGT — tools/seit.mjs, nicht von Hand pflegen)
tests/*.cjs           9 Playwright-Regressionssuiten (e1, e3, e6–e12)
...
**Immer mit der Basis-URL aufrufen.** Alle neun Suiten leiten ihre Zielseite selbst ab; mit einer Seiten-URL laufen e6 und e9 falsch-negativ.
...
for t in e1-regression e3-prompts e6-bibliothek e7-baukasten e8-showroom e9-suche e10-lernenhilfe e11-neuigkeiten e12-anweisungen; do
...
Reale Check-Zahlen: e1 16 · e3 18 · e6 17 · e7 15 · e8 15 · e9 8 · e10 7 · e11 10 · e12 13 (e12 läuft über zwei Viewports).
...
**Push auf `main` = Deploy** (GitHub Pages, `https://ceekay1901.github.io/pilot-skillmarkt/`). `.nojekyll` muss bleiben. Vor dem Push: alle neun Suiten grün und 0 Konsolenfehler auf allen sechs Seiten.
